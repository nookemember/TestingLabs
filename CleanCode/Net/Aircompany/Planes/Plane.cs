...
namespace Aircompany.Planes
{
    public abstract class Plane
    {
        ...
        public override int GetHashCode()
        {
            ...
            hashCode = hashCode * hashCodeCoefficient + EqualityComparer<string>.Default.GetHashCode(_model);
            hashCode = hashCode * hashCodeCoefficient + _maxSpeed.GetHashCode();
            hashCode = hashCode * hashCodeCoefficient + _maxFlightDistance.GetHashCode();
            hashCode = hashCode * hashCodeCoefficient + _maxLoadCapacity.GetHashCode();
            return hashCode;
        }        
